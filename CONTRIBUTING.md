...
3. Please answer the following questions in the bug report:
...
Fill in the Feature Request including the steps that you imagine you would take if the feature you're requesting existed.
Footer
